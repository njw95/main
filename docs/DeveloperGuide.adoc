...
*API* :
link:{repoURL}/src/main/java/ui/Ui.java
...
*API* :
link:{repoURL}/src/main/java/command/Command.java[`Command.java`]
link:{repoURL}/src/main/java/parser/Parser.java[`Parser.java`]
...
*API* :
link:{repoURL}/src/main/java/dictionary/Bank.java[`Bank.java`]
...
*API* :
link:{repoURL}/src/main/java/storage/Storage.java[`Storage.java`]
